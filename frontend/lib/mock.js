...
export const TRUSTED_BY = [
  { name: "NHAI", sector: "Government", context: "National highway plantation corridors — Ayodhya, Prayagraj.", logo: "/logos/nhai.png" },
  { name: "NTPC", sector: "PSU · Power", context: "PSU township landscape at NTPC Dadri and other sites.", logo: "/logos/ntpc.png" },
  { name: "NFL", sector: "PSU · Fertilizers", context: "Beautification and maintenance across NFL Madhya Pradesh.", logo: "/logos/nfl-logo.png" },
  { name: "BHEL", sector: "PSU · Manufacturing", context: "Corporate campus landscape with multi-year AMC.", logo: "/logos/bhel.png" },
  { name: "Indian Oil", sector: "PSU · Oil & Gas", context: "Beautification and landscape maintenance, Odisha.", logo: "/logos/iocl.png" },
  { name: "Indian Railways", sector: "Government", context: "Institutional plantation and landscape works.", logo: "/logos/indian-railways.png" },
  { name: "NBCC", sector: "Navratna CPSE", context: "World Trade Center, Delhi — landscape execution.", logo: "/logos/nbcc.png" },
  { name: "GSECL", sector: "PSU · Power", context: "Landscape works at GSECL Dhuvaran and Ukai.", logo: "/logos/gsecl.png" },
  { name: "TCIL", sector: "PSU · Telecom", context: "Campus horticulture for Telecommunications Consultants India Ltd.", logo: "/logos/tcil.png" },
  { name: "Rajasthan Housing Board", sector: "Government", context: "Extensive plantation works across housing estates.", logo: "/logos/rhb-logo.png" },
  { name: "Nagar Nigam Varanasi", sector: "Municipal", context: "5,000 trees with iron guard across city zones.", logo: "/logos/nagar-nigam-varanasi.jpg" },
  { name: "Chhavni Parishad", sector: "Municipal", context: "Cantonment board landscaping.", logo: "/logos/chhavni-parishad-varanasi.png" },
  { name: "Govt of Uttar Pradesh", sector: "Government", context: "State-level plantation programs.", logo: "/logos/government-of-uttar-pradesh.png" },
  { name: "Sewa International", sector: "CSR · NGO", context: "CSR green development.", logo: "/logos/sewa-international.png" },
  { name: "CSIL", sector: "Corporate", context: "Corporate greening initiatives.", logo: "/logos/csil.png" },
  { name: "Sunbeam", sector: "Private Institutions", context: "Educational campus landscapes.", logo: "/logos/sunbeam.png" },
  { name: "Shaparth", sector: "Real Estate", context: "Residential landscaping.", logo: "/logos/shapearth.png" },
  { name: "Shivalik", sector: "Corporate", context: "Corporate offices and commercial campuses.", logo: "/logos/shivalik.png" },
  { name: "Castillo", sector: "Hospitality", context: "Hotels and hospitality landscapes.", logo: "/logos/castillo.png" },
];
...
// Key Highlights — end-to-end horticulture capabilities that set A2Z apart.
// Rephrased, in-house content. Each entry: index tag, category, icon, title, text, image.
export const HIGHLIGHTS = [
  {
    category: "Design",
    icon: "PencilRuler",
    title: "Bespoke Landscape Design",
    text: "Custom landscape masterplans engineered around your site, brief and budget — from concept sketches to planting layouts.",
    image: "/real-courtyard-garden.jpg",
  },
  {
    category: "Planning",
    icon: "Compass",
    title: "360° Site Marking",
    text: "Complete site survey and precise ground marking so every plant, path and feature lands exactly where it should.",
    image: "/real-avenue-install-day.jpg",
  },
  {
    category: "Analysis",
    ...
    text: "Lab-backed soil analysis that builds the healthiest possible foundation before a single plant goes in the ground.",
    image: "https://images.unsplash.com/photo-1590682680695-43b964a3ae17?crop=entropy&cs=srgb&fm=jpg&q=85&w=1200",
  },
  {
    category: "Supply",
    icon: "Layers",
    title: "Premium Red Soil Supply",
    text: "Bulk supply of screened, nutrient-rich red soil delivered to site for optimal drainage and root growth.",
    image: "https://images.unsplash.com/photo-1562722902-d33533894eea?crop=entropy&cs=srgb&fm=jpg&q=85&w=1200",
  },
  {
    category: "Installation",
    icon: "Sprout",
    title: "Turf Laying & Lawn Installation",
    text: "Expert turf laying for instant, dense, walk-ready lawns — graded, levelled and irrigation-linked.",
    image: "/real-playground-gym.jpg",
  },
  {
    category: "Care",
    icon: "Scissors",
    title: "Year-Round Greenery Maintenance",
    text: "Ongoing professional upkeep — pruning, feeding and health checks — that keeps every landscape vibrant season after season.",
    image: "/real-tree-pruning-work.jpg",
  },
  {
    category: "Hardscape",
    icon: "Grid3x3",
    title: "Decorative Stone Work",
    text: "Natural stone pathways, edging and features that frame the greenery and add lasting structure to your space.",
    image: "/real-paver-walkway.jpg",
  },
  {
    category: "Supply",
    ...
    text: "A wide catalogue of high-germination flowering and foliage seeds, sourced and stored for dependable results.",
    image: "https://images.unsplash.com/photo-1532211387405-12202cb81d7b?crop=entropy&cs=srgb&fm=jpg&q=85&w=1200",
  },
  {
    category: "Organic",
    icon: "Recycle",
    title: "Natural Fertilizers",
    text: "Eco-friendly, soil-safe fertilizers that nourish plants and improve long-term soil health without chemical load.",
    image: "https://images.pexels.com/photos/33995853/pexels-photo-33995853.jpeg?auto=compress&cs=tinysrgb&w=1200",
  },
  {
    category: "Organic",
    icon: "SprayCan",
    title: "Organic Pest Control",
    text: "Plant-friendly, non-toxic pest management that protects your greenery while keeping the surrounding ecosystem safe.",
    image: "https://images.unsplash.com/photo-1747659629851-a92bd71149f6?crop=entropy&cs=srgb&fm=jpg&q=85&w=1200",
  },
  {
    category: "Plants",
    icon: "Flower2",
    title: "Rare & Exotic Plants",
    text: "A curated range of unusual and exotic species to give every garden a distinctive, one-of-a-kind character.",
    image: "/real-vertical-garden.jpg",
  },
  {
    category: "Watering",
    ...
    text: "Water-efficient drip systems that deliver precise hydration to each plant while cutting waste and running costs.",
    image: "https://images.unsplash.com/photo-1748432171507-c1d62fe2e859?crop=entropy&cs=srgb&fm=jpg&q=85&w=1200",
  },
  {
    category: "Service",
    icon: "TreeDeciduous",
    title: "Safe Plant & Tree Relocation",
    text: "Careful lifting, transport and replanting of mature trees and plants with minimal shock and high survival rates.",
    image: "/real-nursery-delivery.jpg",
  },
  {
    category: "Team",
    icon: "Users",
    title: "Expert Plantation Team",
    text: "Work guided by agronomists and horticulturists with deep, hands-on knowledge of India's flora and field conditions.",
    image: "/real-csr-tree-planting.jpg",
  },
  {
    category: "Health",
    ...
    text: "A hand-picked selection of indoor plants proven to freshen indoor air and lift everyday wellbeing.",
    image: "https://images.unsplash.com/photo-1769985841669-c9c4a3e85283?crop=entropy&cs=srgb&fm=jpg&q=85&w=1200",
  },
  {
    category: "Logistics",
    icon: "Truck",
    title: "Bulk Pan-India Delivery",
    text: "Reliable large-scale logistics that move plants and materials to project sites across the country, on schedule.",
    image: "/real-township-avenue-install.jpg",
  },
  {
    category: "Care",
    icon: "CalendarCheck",
    title: "Annual Care Subscription",
    text: "Hassle-free yearly maintenance packages that keep your landscape thriving — with none of the day-to-day worry.",
    image: "/real-flowerbed-roadside.jpg",
  },
  {
    category: "Value",
    ...
    text: "Direct, wholesale-linked pricing that consistently undercuts the market without compromising on quality.",
    image: "/real-hedge-road-wide.jpg",
  },
  {
    category: "Value",
    icon: "TrendingUp",
    title: "Return-on-Investment Plants",
    text: "Timber and fruit-bearing species selected to deliver genuine long-term returns alongside their greenery.",
    image: "/real-avenue-hedge-palms.jpg",
  },
  {
    category: "Decor",
    icon: "Lightbulb",
    title: "Bollard Lighting Supply & Install",
    text: "Elegant bollard lighting supplied and installed to bring your landscape to life after dark — safely and beautifully.",
    image: "/real-nightlighting-nagarnigam.jpg",
  },
];

// States where A2Z is actively operating — mapped to @svg-maps/india location ids.
export const OPERATING_STATES = [
  {
    id: "up",
    name: "Uttar Pradesh",
    note: "Home state — HQ in Varanasi. NHAI highway plantation, Nagar Nigam & PWD urban greening.",
  },
  {
    id: "mp",
    name: "Madhya Pradesh",
    note: "NFL plant beautification and ongoing landscape maintenance.",
  },
  {
    id: "or",
    name: "Odisha",
    note: "IOCL pipeline & colony landscape and multi-year maintenance, Paradeep.",
  },
  {
    id: "dl",
    name: "Delhi",
    note: "NBCC World Trade Center, Nauroji Nagar — corporate landscape execution.",
  },
  {
    id: "gj",
    name: "Gujarat",
    note: "GSECL power-station landscape works at Dhuvaran and Ukai.",
  },
  {
    id: "rj",
    name: "Rajasthan",
    note: "Rajasthan Housing Board plantation and maintenance, Dausa.",
  },
];
